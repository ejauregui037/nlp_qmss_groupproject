...
# EU 
EU_chisq = kilgariff_chisq(df_corp_auth = version_2s_trigrams,  # bad -- all the top words are symbols! but since we have 500 I feel like these can't be that much of an influence?
                ref_list = 'ml_published', 
                compar_grp = 'EU', 
                n_mostcomm = 500, 
                internals = True)
EU_chisq1 = kilgariff_chisq(df_corp_auth = version_2s_trigrams,  
                ref_list = 'ml_2024', 
                compar_grp = 'EU', 
                n_mostcomm = 500, 
                internals = True)
...
# UN
UN_chisq = kilgariff_chisq(df_corp_auth = version_2s_trigrams,  # bad -- all the top words are symbols! but since we have 500 I feel like these can't be that much of an influence?
                ref_list = 'ml_published', 
                compar_grp = 'UN', 
                n_mostcomm = 500, 
                internals = True)
UN_chisq1 = kilgariff_chisq(df_corp_auth = version_2s_trigrams,  
                ref_list = 'ml_2024', 
                compar_grp = 'UN', 
                n_mostcomm = 500, 
                internals = True)
...
# US
US_chisq = kilgariff_chisq(df_corp_auth = version_2s_trigrams,  # bad -- all the top words are symbols! but since we have 500 I feel like these can't be that much of an influence?
                ref_list = 'ml_published', 
                compar_grp = 'US', 
                n_mostcomm = 500, 
                internals = True)
US_chisq1 = kilgariff_chisq(df_corp_auth = version_2s_trigrams,  
                ref_list = 'ml_2024', 
                compar_grp = 'US', 
                n_mostcomm = 500, 
                internals = True)
...
# =============================================================================
# Without numbers [[lots of stopwords--too messy/impactful for bigrams and trigrams]]
# =============================================================================

# EU_chisq = kilgariff_chisq(df_corp_auth = version_3n_bigrams,  # lots of stopwords -- i don't think it's informative!
#                 ref_list = 'ml_technical', 
#                 compar_grp = 'EU', 
#                 n_mostcomm = 500, 
